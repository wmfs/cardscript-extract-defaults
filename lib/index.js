  ...
  function parseElement (element) {
    ...
    switch (element.type) {
      ...
      case 'TextBlock':
        ...
        if (element.qa) {
          applyDefaultValue(defaultValues, false, apiLookupPath, cardListPath, `${element.qa.id}ToggleQa`)
          applyDefaultValue(defaultValues, {}, apiLookupPath, cardListPath, `${element.qa.id}QaComment`)
          applyDefaultValue(defaultValues, {}, apiLookupPath, cardListPath, `${element.qa.id}QaComment.response`)
          applyDefaultValue(defaultValues, [], apiLookupPath, cardListPath, `${element.qa.id}QaComments`)
        }
        break
      case 'Tree':
