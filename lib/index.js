  ...
  function parseElement (element) {
    ...
    switch (element.type) {
      ...
      case 'FactSet':
        ...
        if (element.qa) {
          applyDefaultValue(defaultValues, [], apiLookupPath, cardListPath, `$CHAT.${element.qa.id}.messages`)
          // applyDefaultValue(defaultValues, '', apiLookupPath, cardListPath, `$CHAT.${element.qa.id}.input`)
          applyDefaultValue(defaultValues, '', apiLookupPath, cardListPath, `QA${element.qa.id}`)
        }
      ...
      case 'Tree':
        ...
        break
      case 'Input.Chat':
        applyDefaultValue(defaultValues, [], apiLookupPath, cardListPath, `$CHAT.${element.id}.messages`)
    }
  }
