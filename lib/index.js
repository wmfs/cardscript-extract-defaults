  ...
  function parseElement (element) {
    ...
    switch (element.type) {
      ...
      case 'TextBlock':
        ...
        if (element.qa) {
          // applyDefaultValue(defaultValues, false, apiLookupPath, cardListPath, `$QA.${element.qa.id}.toggleQa`)
          applyDefaultValue(defaultValues, {}, apiLookupPath, cardListPath, `$QA.${element.qa.id}.qaComment`)
          // applyDefaultValue(defaultValues, {}, apiLookupPath, cardListPath, `qa.${element.qa.id}QaComment.response`)
          applyDefaultValue(defaultValues, [], apiLookupPath, cardListPath, `$QA.${element.qa.id}.qaComments`)
        }
        break
      case 'Tree':
