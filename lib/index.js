    ...
    switch (element.type) {
        ...
        if (element.value === 0 || element.value) {
          if (cardListPath.length === 0) {
            if (apiLookupPath.length === 0) {
              ...
              defaultValues.rootView[apiLookupId].params[element.id] = element.value
            }
          } else {
            if (apiLookupPath.length === 0) {
              const cardListId = cardListPath[cardListPath.length - 1]
              ...
              const apiLookupId = apiLookupPath[apiLookupPath.length - 1]
              const cardListId = cardListPath[cardListPath.length - 1]
              defaultValues.cardLists[apiLookupId].params[cardListId][element.id] = element.value
            }
          }
          ...
          if (cardListPath.length === 0) {
            if (apiLookupPath.length === 0) {
              ...
              const apiLookupId = apiLookupPath[apiLookupPath.length - 1]
              defaultValues.rootView[apiLookupId].params[element.id] = ''
            }
          } else {
            if (apiLookupPath.length === 0) {
              const cardListId = cardListPath[cardListPath.length - 1]
              ...
              const apiLookupId = apiLookupPath[apiLookupPath.length - 1]
              const cardListId = cardListPath[cardListPath.length - 1]
              defaultValues.cardLists[apiLookupId].params[cardListId][element.id] = ''
            }
          }
        }
        break
      ...
      case 'Input.ChoiceSet':
        ...
        if (element.isMultiSelect) {
          val = element.value ? element.value.split(',') : []
        } else if (element.value) {
          val = element.value
        }
        ...
        if (val) {
          if (cardListPath.length === 0) {
            if (apiLookupPath.length === 0) {
              defaultValues.rootView[element.id] = val
            } else {
              const apiLookupId = apiLookupPath[apiLookupPath.length - 1]
              defaultValues.rootView[apiLookupId].params[element.id] = val
            }
          } else {
            // todo: apiLookupPath
            const cardListId = cardListPath[cardListPath.length - 1]
            defaultValues.cardLists[cardListId][element.id] = val
          }
        }
        break
      case 'Input.Address':
